      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <label className="flex flex-1 flex-col">
                ...
                <input
                  ...
                  max="10"
                  id="rating"
                  className="p-3 border border-blue-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-300"
                  onChange={handleChange}
        ...
        <div className="flex flex-col gap-4">
          <label className="font-semibold">
            Images:
            <span className="font-normal text-xs text-blue-900 ml-2 uppercase">
          ...
          <div className="flex gap-4">
            <input
              ...
              className="p-3  border border-blue-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-300 w-full"
              id="images"
              accept="image/*"
              multiple
            />
          ...
          {formData.imageUrls.length > 0 &&
            formData.imageUrls.map((url, index) => (
              <div
                key={url}
                className="flex justify-between p-3 border items-center border-blue-500 rounded-lg border-dashed hover:shadow-lg transition duration-300"
              >
                <img
                  src={url}
                  alt="listing image"
          ...
          >
            {dataLoading ? "Updating..." : "Update Listing"}
          </button>
